...
namespace ZBMS
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            ICreateAccountPage_Bindings
        {
            ...
            {
                if (lineNumber == 147 && columnNumber == 185)
                {
                    isobj6ItemsSourceDisabled = true;
                }
                else if (lineNumber == 148 && columnNumber == 206)
                {
                    isobj7ItemsSourceDisabled = true;
                }
                else if (lineNumber == 136 && columnNumber == 155)
                {
                    isobj11ItemsSourceDisabled = true;
                }
                else if (lineNumber == 131 && columnNumber == 158)
                {
            ...
            private void Update_savingsAccount(global::System.Collections.Generic.List<global::System.String> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // CreateAccountPage.xaml line 148
            ...
            private void Update_branchCode(global::System.Collections.Generic.List<global::System.String> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // CreateAccountPage.xaml line 136
            ...
            private void Update_accountTypes(global::System.Collections.Generic.List<global::System.String> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // CreateAccountPage.xaml line 131
        ...
        public void Connect(int connectionId, object target)
        {
            switch(connectionId)
            {
            case 2: // CreateAccountPage.xaml line 118
                {
                    this.MainGrid = (global::Windows.UI.Xaml.Controls.Grid)(target);
                }
                break;
            case 3: // CreateAccountPage.xaml line 162
                {
                ...
                break;
            case 4: // CreateAccountPage.xaml line 179
                {
                ...
                break;
            case 5: // CreateAccountPage.xaml line 199
                {
